/*------------------------------------------------------------------------*/
/*              geoINFO/6000  header file  ( geoinfoextern.h )            */
/*------------------------------------------------------------------------*/
...
//Features  feat[]              ; /* Main Drawing data  Dynamic Array     */
Features  add                   ; /* Add feature variable                 */
Features  feat[2000000]         ; /* Main Drawing data  1,000,000         */
