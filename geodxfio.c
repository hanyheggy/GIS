 ...
 switch (dxf.code)
	{
	 ...
	 switch(dxf.color)
	       {
		case 5:   feat[feat_count].color = blue.pixel  ; break;
		case 1:   feat[feat_count].color = red.pixel   ; break;
		case 6:   feat[feat_count].color = pink.pixel  ; break;
		case 3:   feat[feat_count].color = green.pixel ; break;
		case 4:   feat[feat_count].color = cyan.pixel  ; break;
		case 2:   feat[feat_count].color = yellow.pixel; break;
		case 7:   feat[feat_count].color = white.pixel ; break;
		case 9:   feat[feat_count].color = blue.pixel  ; break;
		case 10:  feat[feat_count].color = red.pixel   ; break;
		case 11:  feat[feat_count].color = pink.pixel  ; break;
		case 12:  feat[feat_count].color = green.pixel ; break;
		case 13:  feat[feat_count].color = cyan.pixel  ; break;
		case 14:  feat[feat_count].color = yellow.pixel; break;
		case 8:   feat[feat_count].color = gray.pixel  ; break;
		case 126: feat[feat_count].color = brown.pixel ; break;
		case 134: feat[feat_count].color = brown.pixel ; break;
		default:  feat[feat_count].color = white.pixel ; break;
	       }
	 goto read_next;
